...
function Overview({ project }: { project: Project }) {
  ...
  return <>
    ...
    <div className="scope-note"><strong>Latest Catalyst update: question writing is merged.</strong> The shell and appearance iteration is next, followed by Available data, result review, and the complete local dual-source owner gate. <a href="/clinical-ai-validation-harness/catalyst-design/" target="_blank" rel="noreferrer">Open the frozen design ↗</a> The OpenMRS trio and older contributions remain separate review work. <button className="text-button" onClick={() => openRecord('efforts', 'CAT-E11')}>Open the active iteration →</button></div>
