MODEL (
  name refapp_28_demo.staging.stg__legacy_obs,
  kind FULL,
...
FROM legacy_27_raw.obs src
  ...
  LEFT JOIN refapp_28_demo.seeds.concept_translation ct_1 ON ct_1.source_concept_id = src.value_coded
  LEFT JOIN refapp_28_demo.seeds.concept_translation ct_2 ON ct_2.source_concept_id = src.value_coded_name_id
;
