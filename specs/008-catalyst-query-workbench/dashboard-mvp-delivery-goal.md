...
in progress pending the live task-closure checkpoint, actual 200% browser zoom,
the durable D1d visual/acceptance evidence bundle, and explicit user acceptance; M4 has not
started.
...
| M3 — Dashboard MVP integration | M2 accepted | The preserved Workbench is recomposed into the binding 4c shell with one editor/composer, chronological turns, Dataset/Widget/Dashboard review and libraries, and publication controls; the real happy path imports into Superset and reconciles to PostgreSQL. | **In progress** — T150/T174/T151 and the 4c shell are complete. The focused Dataset, Widget/Dashboard, and publication implementations and automated tests for T175/T152, T176/T177, and T178/T153 now pass, including source-session hydration and exact receipt gating, but their task boxes remain open for the live closure checkpoint. T179/T154, actual 200% browser zoom, durable D1d visual/acceptance evidence, and explicit user acceptance remain open. |
...
live 4c experience before beginning M4. The first three focused implementation
pairs now have green component/API/browser evidence and are awaiting that
closure checkpoint; T179/T154 still require actual 200% zoom and the durable
acceptance record. The remaining D1
