...
- [ ] T169 [US7] Add red deterministic compatibility/suggestion/binding tests for table, KPI, time-series, grouped/stacked bar, and proportion bar; require an explicit permitted aggregation for every non-table Widget and no implicit default in `targets/catalyst/catalyst-gateway/tests/test_dashboard_widgets.py`
