...
- [ ] T152 [US7] Implement only the Dataset tile, sole result panel, Save Dataset action, and Dataset library proven by T175 in the consolidated `targets/catalyst/catalyst-ui/src/features/query/components/DashboardPublishPanel.tsx` and `targets/catalyst/catalyst-ui/src/features/query/QueryWorkspace.tsx`
- [ ] T176 [US7] Add red Widget/Dashboard UI tests for compatible type review/override, immutable libraries, deterministic append order, and source/catalog mismatch rejection in the consolidated `targets/catalyst/catalyst-ui/src/features/query/components/DashboardPublishPanel.test.tsx`
- [ ] T177 [US7] Implement the Widget review, Dashboard composition, and Dataset/Widget/Dashboard libraries proven by T176 in the consolidated `targets/catalyst/catalyst-ui/src/features/query/components/DashboardPublishPanel.tsx`
