...
const activeLanes: ActiveLane[] = [
  {
    ...
    dossier: "specs/artifacts/lanes/L1-hub-mcp.md",
    relatesTo:
      "Extends F005 and realizes the real-MCP tool layer F008 anticipates. QA-locked architecture: specs/artifacts/lanes/hub-mcp-tools-brief.md.",
    ...
    kickoff:
      "Execute the approved MCP plan in specs/artifacts/lanes/hub-mcp-tools-brief.md in this worktree (med-agent-hub, branch feat/real-mcp-tools off origin/main). Red-first tests for the new MCP tool surface; tests/test_bridge.py (/v1 contract) must stay green throughout; delete the legacy A2A/fake-MCP modules per the brief's deletion list. First, sweep the 5 legacy origin branches per the quick-triage-default-delete rule. PR to hub main gated by hub-ci; after merge, rebuild the container and run the hub-boundary smoke (README /v1 curl with real models + -validated confidence block + trace.jsonl growth) before pushing the harness pin bump.",
  },
  {
    id: "L2",
    ...
    dossier: "specs/artifacts/lanes/L2-reports-human-feedback.md",
    relatesTo:
  ...
  },
  {
    ...
    dossier: "specs/artifacts/lanes/L3-validation-spine-asbuilt.md",
    relatesTo:
  ...
  return (
    <Stack gap={20}>
      ...
      <Text tone="secondary">
        ...
        merge independently. Source of truth for sequencing: specs/artifacts/lanes/dev-roadmap.md.
      </Text>
