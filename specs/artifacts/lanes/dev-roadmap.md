...
specs/roadmap.canvas.tsx               VISUAL   — milestone/feature dependency model + in-flight lane cards
        │
specs/artifacts/lanes/dev-roadmap.md   INDEX    — this doc: north-star, state, lane table, launch sequence, gates
        │
specs/artifacts/lanes/L?-*.md          DOSSIER  — how to run a lane: branch, gates, scope, verbatim kickoff
        │
...
|------|-------|------|--------|-----------------|
| **L1** | med-agent-hub MCP-ification — one FastMCP server at `/mcp`; `kb_search`→MCP tool; delete legacy A2A/fake-MCP | med-agent-hub | Ready (worktree cut) | [dossier](L1-hub-mcp.md) · [brief](hub-mcp-tools-brief.md) |
