...
**Brief**: [`specs/artifacts/planning/catalyst-fhir-sidecar-brief.md`](../planning/catalyst-fhir-sidecar-brief.md) (309-line authoritative brief — the Spec Kit input) · **Spec target**: `specs/011-catalyst-fhir-sidecar-poc` · **Index**: [`dev-roadmap.md`](dev-roadmap.md)
