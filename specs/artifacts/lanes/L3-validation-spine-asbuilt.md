...
**Brief**: none — this is an as-built reconcile; the target spec is the home. **Spec target**: [`specs/006-validation-harness-mvp`](../../006-validation-harness-mvp/spec.md) · **Index**: [`dev-roadmap.md`](dev-roadmap.md)
