...
Renders the actual `stg_form_field.sql` model through the real `sqlmesh render` CLI
...
their original output names; FK/count columns must stay bare.
...
def test_date_columns_are_shifted_under_original_names():
    rendered = _render_stg_form_field()
