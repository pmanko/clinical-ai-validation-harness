...
Renders the actual `stg_provider.sql` model in-process through the real SQLMesh
...
names; FK/text/boolean columns must stay bare.
...
MODEL = "refapp_28_demo.stg_provider"
