"""Per-concept-class binding probes against the live O3 RefApp (T060-T063c).

After the transform produces `refapp_28_demo.sql` and it's loaded into
...
Outputs `artifacts/<run>/refapp-binding/report.json` per SC-013.
"""
